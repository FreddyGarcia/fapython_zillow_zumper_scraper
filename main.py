...
def get_contacts(listingId, start=0):
    try:
...
def main():
    ...
    if is_authenticated:
        ...
        with click.progressbar(listings, label='Looking for contacts') as bar:
            ...
            for listing in bar:
                contacts = get_contacts(listing)

                for contact in contacts:
                    contact_info = get_contact_field(contact)
